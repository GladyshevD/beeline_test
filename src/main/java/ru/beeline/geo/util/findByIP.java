...
public class findByIP {
    ...
    public static String getDataBaseCity(String ipAddress) throws IPFindingException, UrlFormingException {
        ...
        try {
            ...
            throw new IPFindingException("Приложению не удалось определить ваше местоположение");
        }
